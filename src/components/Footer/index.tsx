...
export function Footer() {
  return (
    <div className={styles.container}>
      <Image src="/images/logo-white.png" width={72} height={75} alt="Logo do rodapé"/>
      ...
      <ul role="menu">
        <li role="menuitem">
          <a href="https://www.instagram.com/decioneeto/" target="_blank ">
            <Image src="/images/instagram.svg" width={24} height={24} alt="Ver meu perfil no Instagram"/>
          </a>
        </li>
        <li role="menuitem">
          <a href="https://www.linkedin.com/in/decioneto/" target="_blank" >
            <Image src="/images/linkedin.svg" width={24} height={24} alt="Ver meu perfil no Linkedin"/>
          </a>
        </li>
        <li role="menuitem">
          <a href="https://dribbble.com/decioneto" target="_blank">
            <Image src="/images/dribbble.svg" width={24} height={24} alt="Ver meu perfil no Dribbble"/>
          </a>
        </li>
        <li role="menuitem">
          <a href="https://www.behance.net/decioneto" target="_blank ">
            <Image src="/images/behance.svg" width={24} height={24} alt="Ver meu perfil no Behance"/>
          </a>
        </li>
      </ul>
